<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.php" class="app-brand-link">
            ...
            <span class="app-brand-text menu-text fw-bolder" style="font-size: 30px;">AST</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item <?php if($active == 'form'){ echo 'active open';}?>">
            ...
            <ul class="menu-sub">
                <li class="menu-item <?php if($page == 'service provider'){ echo 'active';}?>">
                    <a href="hire-developer.php" class="menu-link">
                        <div data-i18n="Account">Hire Developer</div>
                    </a>
                </li>
        ...
        <!-- <li class="menu-item <?php if($page == 'Blog'){ echo 'active open';}?>">
            <a href="insert_blog.php" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Insert Blog</div>
            </a>
        </li> -->
